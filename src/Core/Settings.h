...
#define COMMON_SETTINGS(M, ALIAS) \
    ...
    M(Bool, query_plan_joing_in_order, true, "Enable JOIN optimization for joining data using `full_sorting_merge` algorithm in corresponding order in MergeTree tables.", 0) \
